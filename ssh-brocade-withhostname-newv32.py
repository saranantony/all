...
def critsit():
    ...
    plt.savefig('' + my_folder + '\lunwriteiocount' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(Lun_name)):
        X = []
    ...
    plt.savefig('' + my_folder + '\lunreadbandwidth' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(Lun_name)):
        X = []
    ...
    plt.savefig('' + my_folder + '\lunwritebandwidth' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(Lun_name)):
        X = []
    ...
    plt.savefig('' + my_folder + '\lunreadlatency' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(Lun_name)):
        X = []
    ...
    plt.savefig('' + my_folder + '\lunwritelatency' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(array_name)):
        params1 = (
    ...
    for i in range(len(portname)):
        ...
        plt.xlabel('Time')
        plt.legend(portname,loc="upper center",bbox_to_anchor=(1,0.5),ncol=3)
    plt.savefig('' + my_folder + '\port_throughput' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    ...
    for i in range(len(portname)):
        ...
        plt.xlabel('Time')
        plt.legend(portname,loc="upper center",bbox_to_anchor=(1,0.5),ncol=3)
    plt.savefig('' + my_folder + '\port_READ_RESPONSE' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(portname)):
        X = []
        ...
        plt.xlabel('Time')
        plt.legend(portname,loc="upper center",bbox_to_anchor=(1,0.5),ncol=3)
    plt.savefig('' + my_folder + '\port_WRITE_RESPONSE' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(array_name)):
        params2 = (
    ...
    for i in range (len(adaptorid)):
        ...
        plt.xlabel('Time')
        plt.legend(adaptorid,loc="upper center",bbox_to_anchor=(1,0.5),ncol=3)
    plt.savefig('' + my_folder + '\processor' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
    for i in range(len(array_name)):
        params3 = (
    ...
    for i in range(len(clpr)):
        ...
        plt.ylabel('CWP')
        plt.xlabel('Time')
        plt.legend(clpr,loc="upper center",bbox_to_anchor=(1,0.5),ncol=3)

    plt.savefig('' + my_folder + '\cwp' + date + '.png',dpi=300)
    plt.clf()
    plt.close()
